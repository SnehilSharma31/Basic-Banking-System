...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/SNEHIL PHOTO.JPG" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created with ❤️ by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Snehil Sharma</h1>
            <p style="color:gray;"><b>Intern at The Sparks Foundation <br> Kalinga Institute of Industrial Technology (KIIT University), Bhubaneswar</b></p>
    </center>
