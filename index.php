...
<head>
    ...
    <title>Welcome to NexBank</title>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: local('Harlow Solid Italic'), url('HARLOWSI_1.woff') format('woff');
        }
        span {
            font-family: 'Harlow Solid Italic';
        }
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> </b><span>NexBank !</span></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/bank.webp" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <img src="statics/send.png" style="width:41%"><br>
                    ...
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            <img src="statics/cust.png" style="width:34%"><br><br>
                    ...
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            <img src="statics/bal.png" style="width:35%"><br><br>
